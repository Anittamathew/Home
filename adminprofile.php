...
<link href="admin/css/demo-page1.css" rel="stylesheet" type="text/css" media="all">

<link href="admin/css/examples1.css" rel="stylesheet" type="text/css" media="all">
<link href="admin/css/bootstrap1.css" rel="stylesheet" type="text/css" media="all">
<!-- Custom Theme files -->
...
<!--static chart-->
<script src="admin/js/Chart.min1.js"></script>
<!--//charts-->
<!-- geo chart -->
    ...
    <!--<script src="lib/html5shiv/html5shiv.js"></script>-->
     <!-- Chartinator  -->
    <script src="admin/js/chartinator1.js" ></script>
...
<!--skycons-icons-->
<script src="admin/js/skycons1.js"></script>
<!--//skycons-icons-->
</head>
<body>	
...
<?php 
							$totalno1= "SELECT * FROM registration";
							if ($result= mysqli_query($con, $totalno1))
                            {
...
<div class="copyrights">
	 <p>© 2022 All Rights Reserved | <a href="http://w3layouts.com/" target="_blank">Home</a> </p>
</div>	
