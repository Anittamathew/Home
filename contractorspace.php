...
if(isset($_POST['send']))
{
  ...
  $q="INSERT INTO contractor(lo_id,choose,companyname,spworks,days,phone,address)VALUES($lo_id,'$choose','$companyname','$spworks','$days','$phone','$address')";
  // var_dump($q);
  // exit();
...
$s="SELECT * FROM contractor INNER JOIN registration on contractor.lo_id=registration.lo_id WHERE contractor.lo_id=$lo_id";
		if(!$stmt=mysqli_query($con,$s))
		{
			die("prepare statement error1");
		}
...
if(isset($_POST['edit']))
{
  ...
  $address=$_POST['address'];
   // $email=$_POST['email'];
  $qu="UPDATE contractor SET companyname='$companyname',spworks='$spworks',days='$days',phone='$phone',address='$address'";

 $result=$con->query($qu);
  if($result)
  {
     // echo "<script>window.location.replace('astrologerspace.php');</script>";
    header("Location:contractorspace.php");
  }
}
...
<html lang="en">
<head>
<title>Vitae a Personal Websites Category Flat Bootstrap Responsive Website Template | Home :: w3layouts</title>
<!-- for-mobile-apps -->
	...
	<div class="about" id="about">
		...
		<div class="col-md-8 w3l-about" style="margin-top: 20%;">
					<div class="w3ls-heading">
						<!--<h2>I'm a Contractor based in Kerala, India. I have a passion for designing and love to provide attractive plans for constructing your beautiful buildings.</h2>-->
					</div>
					...
					<br>
					<div class="w3l-button">
						<a href="deletecontractor.php?r_id=<?php echo $result['r_id'];?>">remove account</a>
					</div>
			</div>	
					...
					<div class="about"> 
						...
						<div class="col-md-8 col-sm-8 col-xs-8 about-right wthree">
							...
							<ul class="address">
								...
								<li>
									<ul class="agileits-address-text ">
										<li><b>SPECIALISED WORKS</b></li>
										<li><input type="text" name="spworks" value="<?php echo $result['spworks'];?>" style="border: none;"></li>
									</ul>
								</li>
								<li>
									<ul class="agileits-address-text ">
										<li><b>DAYS AVAILABLE</b></li>
										<li><input type="text" name="days" value="<?php echo $result['days'];?>" style="border: none;"></li>
									</ul>
								</li>
								<li>
									<ul class="agileits-address-text">
				...
				<h3 class="w3l-heading">contact</h3>
				 <div class="w3_agile-contact jarallax"> 
					<form action="#" method="post">
						 ...
						 <label style="color:#e2004d;">Are you working under a company?</label>
						 <input type="radio"  name="choose" placeholder="Yes" class="radio" required><label style="color:#e2004d;">Yes<label>
						 <input type="radio" placeholder="No" name="choose" class="radio" required><label style="color:#e2004d;">No<label>
						<input type="text" placeholder="Company Name" name="companyname" class="name">
						<input type="text" placeholder="Specialised works" name="spworks" class="name" required>
						<input type="text" placeholder="Days available" name="days" class="name" required>
						<input type="text" placeholder="Phone Number" name="phone" class="name" required><br>
...
<div class="agileits_w3layouts-footer text-center">
	<div class="container">
		<p>&copy; 2022 Home. All rights reserved | <a href="index.php">Home</a></p>
	</div>
</div>	
<!-- //footer -->	
<!-- //contact -->
