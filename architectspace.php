...
$q="INSERT INTO architect(lo_id,image,companyname,phone,website,address,choose,approve,proof)VALUES($lo_id,'$image','$companyname','$phone','$website','$address','$choose','$approve','$proof')";
  // var_dump($q);
  // exit();
...
$s="SELECT * FROM architect INNER JOIN registration on architect.lo_id=registration.lo_id WHERE architect.lo_id=$lo_id";
		if(!$stmt=mysqli_query($con,$s))
		{
			die("prepare statement error1");
		}
...
if(isset($_POST['edit']))
{
  ...
  $address=$_POST['address'];
   // $email=$_POST['email'];
  $qu="UPDATE architect SET companyname='$companyname',website='$website',phone='$phone',address='$address'";

 $result=$con->query($qu);
  if($result)
  {
     // echo "<script>window.location.replace('astrologerspace.php');</script>";
    header("Location:architectspace.php");
  }
}
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top" style="background-color: #000;">
	<div class="banner-text-w3ls">
		 <div class="header1" id="home">
		 	<div class="banner-text-w3ls" style="margin-top: 4%">
		 	<br><br><br>
		 ...
		 <div class="container">-->
			...
			<div class="col-md-8 w3l-about" style="margin-top: 20%;">
					<div class="w3ls-heading">
						<!--<h2>I'm an Architect based in Kerala, India. I have a passion for designing and love to provide attractive plans for constructing your beautiful buildings.</h2>-->
					</div>
					<!--<div class="w3ls-about-info">
						<p><?php echo $result['choose'];?></p>
					</div>-->
				...
				<div class="modal-body">
					<div class="about"> 
						<div class="col-md-4 col-sm-4  col-xs-4 about-left ">
							<img src="images/<?php echo $result['image'];?>" class="img-responsive" alt=""/>
						</div>
