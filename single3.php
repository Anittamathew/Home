   ...
   <div class="header-bottom">
   	<div class="wrap">
		...
		<ul class="megamenu skyblue">
			...
			<li class="grid"><a class="color2" href="chatarchite.php">Chat</a>
				</li>
		   ...
		   <div class="clear"></div>
             ...
             <div class="main">
				...
				?>
				    <div class="col_1_of_3 span_1_of_3"><a href="planview.php?add_id=<?php echo $add_id;?>">
