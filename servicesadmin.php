...
<?php
	$q="SELECT * FROM addservices INNER JOIN login on addservices.lo_id=login.lo_id";
    	...
    	<div class="col-md-3 product-grid">
    		<div class="product-items">
	    		...
	    		<div class="produ-cost">
	    			...
	    			<a href="mpro_approve.php?addpro_id=<?php echo $addpro_id;?>" style="a:visited * {
  color: black;
}"><span class="glyphicon glyphicon-thumbs-up" style="color: white;size: 30px;"></span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    			<a href="mpro_disapprove.php?addpro_id=<?php echo $addpro_id;?>"><span class="glyphicon glyphicon-thumbs-down" style="color: white;size: 30px;"></span></a>
...
<div class="copyrights">
	 <p>© 2022. All Rights Reserved <a href="index.php" target="_blank">| Home</a> </p>
</div>	
