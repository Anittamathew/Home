...
$s="SELECT * FROM contractor where lo_id=$lo_id";
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav">
					...
					<li class="nav-item">
						<a class="nav-link" href="addcontracts.php">Add Works</a>
					</li>
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true"
							...
							Notifications<span class="badge badge-light">
								<?php 
							$totalno1= "SELECT * FROM viewmore WHERE lo_id='$lo_id' AND seen='unread'";
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<?php
								$m3="SELECT * FROM viewmore WHERE lo_id='$lo_id' AND seen='unread'";
				...
				while($row1=mysqli_fetch_array($stmt))
				{
					$d[]=$row1;
 						 ...
 						 $name=$row1['name'];
 						 $email=$row1['email'];
 						 $view_id=$row1['view_id'];
							?>
							<a class="dropdown-item text-center" href="" style="color:blue;"><?php echo $name;?>&nbsp;&nbsp;&nbsp;<?php echo $email;?>&nbsp;&nbsp;&nbsp;<?php echo $planname;?></a>
							<a class="dropdown-item text-center" href="arcnotread.php?view_id=<?php echo $view_id;?>"><button class="btn btn-primary">view</button></a>
							<?php
								}
							?>
						</div>
